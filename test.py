...
# print(ex.ecartType,ex.ecarttyp2())
# print(statistics.stdev(ex.serie),st.tstd(ex.serie))
# print(ex.variance,ex.moment(2)-ex.moment(1)**2)
print(ex.asymetrie(),st.skew(ex.serie))
print(ex.aplatissement(),st.kurtosis(ex.serie))      #?
# ex.histogramme()
# classes1=ex.classer([0,.0001,.003,.11,.4])
classes1=ex.classer([2,4,9,11,12])
# print(classes1[1])
# print(classes1[2])
# print(classes1[3])
# print(classes1[4])
